...
public class JDialogImpostazioniOld extends javax.swing.JDialog {
    ...
    public void impostaLarghezza() {
        ...
        Rectangle maxrect = GraphicsEnvironment.getLocalGraphicsEnvironment().getMaximumWindowBounds();
        height = (int) (800 * coeff);
        if (height > maxrect.getHeight()) {
            height = (int) (maxrect.getHeight() * 0.9d);
        }
...
//                System.out.println(pathname + " | " + pathname.getName());
    ...
    public void init(java.awt.Frame parent, boolean modal, boolean vaisudb) {
        ...
        texEsigDiffReadytec.setDocument(new LimitedPlainDocument(texEsigDiffReadytec, 1));
        
        if (Db.tunnel_force) {
            labTunnelAutomatico.setVisible(true);
        } else {
            labTunnelAutomatico.setVisible(false);
        }
...
//            setIconImage(new ImageIcon(getClass().getResource("/res/48x48.gif")).getImage());            
        ...
        scrollAzienda.getVerticalScrollBar().setUnitIncrement(16);
...
//        comLook.addItem("Tonic");
        ...
        try {
            ...
            //proxy
            proxy_auto.setSelected(fileIni.getValueBoolean("proxy", "auto", true));
            proxy_server.setText(fileIni.getValue("proxy", "server", ""));
            proxy_porta.setText(fileIni.getValue("proxy", "porta", ""));
            controllaProxy();
...
//            ssl_keystore.setText(main.fileIni.getValue("db", "ssl_keystore"));
            ...
            if (!vaisudb) {
                try {
                    ...
                    this.texLabelFornitore.setText(temp.getString("label_fornitore"));
                    this.texLabelFornitoreEng.setText(temp.getString("label_fornitore_eng"));
...
//                    this.texNoteFattAcquisto.setText(temp.getString("testo_piede_fatt_a"));
                    ...
                    provvigioni_tipo_calcolo.setSelectedIndex(cu.i0(temp.getInt("provvigioni_tipo_calcolo")));
                    ...
                    try {
                        ...
                        estraiAccontiFatseq.setSelected(cu.toBoolean(temp.getString("export_fatture_estrai_acconti")));
                        String esig = cu.s(temp.getString("export_fatture_esig_diff_iva"));
                        texEsigDiffReadytec.setText(StringUtils.isBlank(esig) ? "0" : esig);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                } catch (Exception err) {
...
//            this.texIvaSpese.setText(Db.nz(fileIni.getValue("iva", "codiceIvaSpese"), ""));
            if (Db.conn != null && !Db.conn.isClosed()) {
                ...
                try {
                    texIvaBollo.setText((String) DbUtils.getObject(Db.getConn(true), "select codiceIvaBollo from dati_azienda limit 1"));
                } catch (Exception e) {
                    e.printStackTrace();
                }
...
//            texContoRicaviReadytec.setText(fileIni.getValue("readytec", "codiceContoDefault", ""));
            ...
            try {
                ...
                boolean stampaFax = fileIni.getValueBoolean("pref", "stampaFax", false);
                ...
                cheStampaFax.setSelected(stampaFax);
                ...
                /* NOTE STANDARD DOCUMENTI */
                String noteStandard = fileIni.getValue("pref", "noteStandard");
                String noteStandardDdt = fileIni.getValue("pref", "noteStandardDdt");
                String noteStandardOrdi = fileIni.getValue("pref", "noteStandardOrdi");
                String noteStandardPrev = fileIni.getValue("pref", "noteStandardPrev");
                String noteStandardFattAcquisto = fileIni.getValue("pref", "noteStandardFattAcquisto");
                String noteStandardDdtAcquisto = fileIni.getValue("pref", "noteStandardDdtAcquisto");
                String noteStandardOrdiAcquisto = fileIni.getValue("pref", "noteStandardOrdiAcquisto");
                String noteStandardPrevAcquisto = fileIni.getValue("pref", "noteStandardPrevAcquisto");
                texNoteStandard.setText(noteStandard);
                texNoteStandardDdt.setText(noteStandardDdt);
                texNoteStandardOrdi.setText(noteStandardOrdi);
                texNoteStandardPrev.setText(noteStandardPrev);
                texNoteStandardFattAcquisto.setText(noteStandardFattAcquisto);
                texNoteStandardDdtAcquisto.setText(noteStandardDdtAcquisto);
                texNoteStandardOrdiAcquisto.setText(noteStandardOrdiAcquisto);
                texNoteStandardPrevAcquisto.setText(noteStandardPrevAcquisto);

                /* CONDIZIONI DI VENDITA */
                String condVendFatt = fileIni.getValue("pref", "condizioniVenditaFattura");
                String condVendDocu = fileIni.getValue("pref", "condizioniVenditaDdt");
                String condVendOrdi = fileIni.getValue("pref", "condizioniVenditaOrdine");
                String condVendPrev = fileIni.getValue("pref", "condizioniVenditaPreventivo");
                /* CONDIZIONI DI ACQUISTO */
                String condAcquFatt = fileIni.getValue("pref", "condizioniAcquistoFattura");
                String condAcquDocu = fileIni.getValue("pref", "condizioniAcquistoDdt");
                String condAcquOrdi = fileIni.getValue("pref", "condizioniAcquistoOrdine");
                String condAcquPrev = fileIni.getValue("pref", "condizioniAcquistoPreventivo");

                texCondVenditaFatt.setText(condVendFatt);
                texCondVenditaDdt.setText(condVendDocu);
                texCondVenditaOrdi.setText(condVendOrdi);
                texCondVenditaPrev.setText(condVendPrev);
                texCondAcquistoFatt.setText(condAcquFatt);
                texCondAcquistoDdt.setText(condAcquDocu);
                texCondAcquistoOrdi.setText(condAcquOrdi);
                texCondAcquistoPrev.setText(condAcquPrev);
...
//                comTipoStampaOrdine.setSelectedItem(preferences.get("tipoStampaOrdine", null));
                ...
                cheFiltraCliFor.setSelected(fileIni.getValueBoolean("pref", "filtraCliFor", false));
                ...
                if (!fileIni.existKey("altro", "da_preventivo")) {
                    da_preventivo.setText("Da Preventivo");
                } else {
                    da_preventivo.setText(fileIni.getValue("altro", "da_preventivo", "Da Preventivo"));
                }

                comColliAutomatici.setSelectedIndex(Integer.parseInt(fileIni.getValue("pref", "colli_automatici", "0")));
                comNumerazioneRighe.setSelectedItem(fileIni.getValue("pref", "numerazione_righe", "1,2,3..."));
            } catch (Exception err) {
                err.printStackTrace();
            }
            ...
            if (Db.conn != null && !Db.conn.isClosed()) {
                if (!main.utente.getPermesso(Permesso.PERMESSO_IMPOSTAZIONI, Permesso.PERMESSO_TIPO_SCRITTURA) && main.utente.ex == null) {
...
//        pack();
    ...
    public void updateTabellaSoglieProvvigioni(boolean first) {
        ...
        if (first) {
            ...
            chePercMedia.setSelected(fileIni.getValueBoolean("pref", "provvigioniPercMedia", false));
        }
        ...
        griglia_soglie.getColumnModel().getColumn(1).setHeaderValue("fino a Sconto");
    }
    ...
    private void initComponents() {
        ...
        scrollAzienda = new javax.swing.JScrollPane();
        ...
        texLabelFornitore = new javax.swing.JTextField();
        jLabel62 = new javax.swing.JLabel();
        jLabel63 = new javax.swing.JLabel();
        texLabelFornitoreEng = new javax.swing.JTextField();
        nomifilepdf = new javax.swing.JButton();
        ...
        comColliAutomatici = new javax.swing.JComboBox();
        texIvaBollo = new javax.swing.JTextField();
        comIva = new javax.swing.JButton();
        comIva1 = new javax.swing.JButton();
        comIva2 = new javax.swing.JButton();
        jLabel73 = new javax.swing.JLabel();
        comNumerazioneRighe = new javax.swing.JComboBox();
        ...
        cheStampaFax = new javax.swing.JCheckBox();
        cheFiltraCliFor = new javax.swing.JCheckBox();
        ...
        labTunnelAutomatico = new javax.swing.JLabel();
        ...
        proxy_auto = new javax.swing.JCheckBox();
        jLabel65 = new javax.swing.JLabel();
        proxy_server = new javax.swing.JTextField();
        proxy_porta = new javax.swing.JTextField();
        jLabel66 = new javax.swing.JLabel();
        jLabel67 = new javax.swing.JLabel();
        proxy_server_socks = new javax.swing.JTextField();
        jLabel68 = new javax.swing.JLabel();
        proxy_porta_socks = new javax.swing.JTextField();
        teamviewer = new javax.swing.JButton();
        ...
        da_preventivo = new javax.swing.JTextField();
        ...
        texNoteStandardDdt = new javax.swing.JTextArea();
        jPanel18 = new javax.swing.JPanel();
        jScrollPane12 = new javax.swing.JScrollPane();
        texNoteStandardOrdi = new javax.swing.JTextArea();
        jPanel22 = new javax.swing.JPanel();
        jScrollPane17 = new javax.swing.JScrollPane();
        texNoteStandardPrev = new javax.swing.JTextArea();
        jPanel30 = new javax.swing.JPanel();
        jScrollPane22 = new javax.swing.JScrollPane();
        texNoteStandardFattAcquisto = new javax.swing.JTextArea();
        jPanel31 = new javax.swing.JPanel();
        jScrollPane23 = new javax.swing.JScrollPane();
        texNoteStandardDdtAcquisto = new javax.swing.JTextArea();
        jPanel32 = new javax.swing.JPanel();
        jScrollPane24 = new javax.swing.JScrollPane();
        texNoteStandardOrdiAcquisto = new javax.swing.JTextArea();
        jPanel33 = new javax.swing.JPanel();
        jScrollPane25 = new javax.swing.JScrollPane();
        texNoteStandardPrevAcquisto = new javax.swing.JTextArea();
        jTabbedPane6 = new javax.swing.JTabbedPane();
        jPanel20 = new javax.swing.JPanel();
        jScrollPane13 = new javax.swing.JScrollPane();
        texCondVenditaFatt = new javax.swing.JTextArea();
        jPanel23 = new javax.swing.JPanel();
        jScrollPane14 = new javax.swing.JScrollPane();
        texCondVenditaDdt = new javax.swing.JTextArea();
        jPanel24 = new javax.swing.JPanel();
        jScrollPane15 = new javax.swing.JScrollPane();
        texCondVenditaOrdi = new javax.swing.JTextArea();
        jPanel25 = new javax.swing.JPanel();
        jScrollPane16 = new javax.swing.JScrollPane();
        texCondVenditaPrev = new javax.swing.JTextArea();
        jTabbedPane7 = new javax.swing.JTabbedPane();
        jPanel26 = new javax.swing.JPanel();
        jScrollPane18 = new javax.swing.JScrollPane();
        texCondAcquistoFatt = new javax.swing.JTextArea();
        jPanel27 = new javax.swing.JPanel();
        jScrollPane19 = new javax.swing.JScrollPane();
        texCondAcquistoDdt = new javax.swing.JTextArea();
        jPanel28 = new javax.swing.JPanel();
        jScrollPane20 = new javax.swing.JScrollPane();
        texCondAcquistoOrdi = new javax.swing.JTextArea();
        jPanel29 = new javax.swing.JPanel();
        jScrollPane21 = new javax.swing.JScrollPane();
        texCondAcquistoPrev = new javax.swing.JTextArea();
        ...
        chePercMedia = new javax.swing.JCheckBox();
        jLabel70 = new javax.swing.JLabel();
        provvigioni_tipo_calcolo = new javax.swing.JComboBox();
        ...
        estraiAccontiFatseq = new javax.swing.JCheckBox();
        jLabel72 = new javax.swing.JLabel();
        texEsigDiffReadytec = new javax.swing.JTextField();
        ...
        jTabbedPane1.setName("tab_principale"); // NOI18N

        scrollAzienda.setBorder(null);
        scrollAzienda.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        ...
        texLabelMerce.setColumns(13);

        texLabelClienteEng.setColumns(13);

        texLabelMerceEng.setColumns(13);
        ...
        texLabelFornitore.setColumns(13);

        jLabel62.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel62.setText("Etichetta fornitore Italiano:");
        jLabel62.setToolTipText("Etichetta per cliente in fattura");

        jLabel63.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel63.setText("Etichetta fornitore Inglese:");
        jLabel63.setToolTipText("Etichetta per cliente in fattura");

        texLabelFornitoreEng.setColumns(13);

        nomifilepdf.setText("Gestione nomi file pdf");
        nomifilepdf.setToolTipText("Puoi impostare il nome del file in italiano e inglese per la creazione dei pdf");
        nomifilepdf.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nomifilepdfActionPerformed(evt);
            }
        });
                                    ...
                                    .add(jPanel11Layout.createSequentialGroup()
                                        ...
                                        .add(jPanel11Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                            ...
                                            .add(jPanel11Layout.createSequentialGroup()
                                                .add(comFile1)
                                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                                .add(tnxFileLogo1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 58, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))))
                                    .add(jPanel11Layout.createSequentialGroup()
                                        .add(jLabel3)
                                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                    ...
                    .add(jPanel11Layout.createSequentialGroup()
                        .add(jPanel11Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jPanel11Layout.createSequentialGroup()
                                .add(jLabel62)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(texLabelFornitore, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                                .add(jLabel63, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 119, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(texLabelFornitoreEng, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                            .add(nomifilepdf))
                        .add(0, 0, Short.MAX_VALUE))))
        );

        jPanel11Layout.linkSize(new java.awt.Component[] {jLabel3, jLabel4, jLabel54, jLabel55, jLabel62, jLabel63}, org.jdesktop.layout.GroupLayout.HORIZONTAL);
        ...
        jLabel2.setText("IVA spese");
        jLabel2.setToolTipText("<html>\nCodice iva automatico per spese di trasporto e di incasso<br><br>\n<b>Se lasciato vuoto l'IVA sulle spese verrà calcolata in base<br>alla ripartizione dei codici IVA inseriti in fattura</b>\n</html>");

        texIvaSpese.setColumns(3);
        ...
        jLabel69.setText("Colli automatici");
        jLabel69.setToolTipText("Seleziona il tipo di numerazione delle Fatture in base al DL 216/2012\nValido per le fatture dal 1/1/2013");

        comColliAutomatici.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "No", "Calcolato in base al numero colli per riga o le quantità per riga", "Calcolato in base al numero colli per riga o il numero di righe" }));

        texIvaBollo.setColumns(3);

        comIva.setText("...");
        comIva.setMargin(new java.awt.Insets(2, 2, 2, 2));
        ...
        comIva1.setText("...");
        comIva1.setMargin(new java.awt.Insets(2, 2, 2, 2));
        comIva1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comIva1ActionPerformed(evt);
            }
        });

        comIva2.setText("...");
        comIva2.setMargin(new java.awt.Insets(2, 2, 2, 2));
        comIva2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                comIva2ActionPerformed(evt);
            }
        });

        jLabel73.setText("Numerazione righe");
        jLabel73.setToolTipText("Seleziona il tipo di numerazione delle Fatture in base al DL 216/2012\nValido per le fatture dal 1/1/2013");

        comNumerazioneRighe.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "1,2,3...", "10,20,30...", "100,200,300..." }));
            ...
            .add(jPanel6Layout.createSequentialGroup()
                ...
                .add(jPanel6Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel6Layout.createSequentialGroup()
                        .add(jLabel69)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(comColliAutomatici, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(jPanel6Layout.createSequentialGroup()
                        .add(jLabel8)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        ...
                        .add(jLabel71)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(texIvaBollo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(0, 0, 0)
                        .add(comIva2)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jLabel23)
                    ...
                    .add(jPanel6Layout.createSequentialGroup()
                        .add(jLabel73)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(comNumerazioneRighe, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel6Layout.linkSize(new java.awt.Component[] {comIva, texIvaDefault}, org.jdesktop.layout.GroupLayout.VERTICAL);

        jPanel6Layout.linkSize(new java.awt.Component[] {comIva1, texIvaSpese}, org.jdesktop.layout.GroupLayout.VERTICAL);

        jPanel6Layout.linkSize(new java.awt.Component[] {comIva2, texIvaBollo}, org.jdesktop.layout.GroupLayout.VERTICAL);
        ...
        cheStampaDestDiversaSotto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cheStampaDestDiversaSottoActionPerformed(evt);
            }
        });
        ...
        cheStampaCellulare.setToolTipText("Permette di stampare il numero di cellulare nei documenti");
        ...
        cheStampaPivaSotto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cheStampaPivaSottoActionPerformed(evt);
            }
        });
        ...
        cheStampaFax.setText("Stampa Fax su documenti");
        cheStampaFax.setToolTipText("Permette di stampare il numero di fax nei documenti");
        cheStampaFax.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        cheStampaFax.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);

        cheFiltraCliFor.setText("Filtra selezione cliente/fornitore");
        cheFiltraCliFor.setToolTipText("Filtra gli elenchi di selezione dei clienti o fornitori in base al tipo di documento");
        cheFiltraCliFor.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        cheFiltraCliFor.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);
            ...
            .add(jPanel4Layout.createSequentialGroup()
                ...
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                        .add(cheSerie, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 279, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(cheStampaDestDiversaSotto)
                        .add(cheTotali, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 279, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(cheNumerazioneNoteCredito, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 279, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(org.jdesktop.layout.GroupLayout.LEADING, cheScadenzeOrdini))
                    .add(chePersona, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 279, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(cheUpdateListini, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 279, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                ...
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                        ...
                        .add(org.jdesktop.layout.GroupLayout.LEADING, cheStampaTelefono))
        ...
        jPanel4Layout.linkSize(new java.awt.Component[] {cheArrotondamento, cheAttivaUtenti, cheFiltraCliFor, cheNumerazioneNoteCredito, chePersona, cheScadenzeOrdini, cheSerie, cheStampaDestDiversaSotto, cheTotali, cheUpdateListini}, org.jdesktop.layout.GroupLayout.HORIZONTAL);

        jPanel4Layout.linkSize(new java.awt.Component[] {cheApriFinestreGrandi, cheControlliIva, cheControlloNumeriAvvio, cheInclNumProForma, chePrezziCliente, cheSoloItaliano, cheStampaCedoliniBonifici, cheStampaCellulare, cheStampaFax, cheStampaPivaSotto, cheStampaScrittaInvoicex, cheStampaTelefono}, org.jdesktop.layout.GroupLayout.HORIZONTAL);
        ...
        jPanel4Layout.linkSize(new java.awt.Component[] {cheApriFinestreGrandi, cheControlliIva, cheInclNumProForma, chePrezziCliente, cheSoloItaliano, cheStampaCedoliniBonifici, cheStampaCellulare, cheStampaScrittaInvoicex, cheStampaTelefono}, org.jdesktop.layout.GroupLayout.VERTICAL);

        jPanel4Layout.linkSize(new java.awt.Component[] {cheArrotondamento, cheNumerazioneNoteCredito, chePersona, cheScadenzeOrdini, cheSerie, cheTotali, cheUpdateListini}, org.jdesktop.layout.GroupLayout.VERTICAL);
        ...
        scrollAzienda.setViewportView(jPanel1);

        jTabbedPane1.addTab("Azienda", scrollAzienda);
        ...
        texPersonalizzazioni.setColumns(20);
        ...
        ssh_password.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ssh_passwordActionPerformed(evt);
            }
        });

        labTunnelAutomatico.setFont(labTunnelAutomatico.getFont().deriveFont(labTunnelAutomatico.getFont().getStyle() | java.awt.Font.BOLD));
        labTunnelAutomatico.setForeground(new java.awt.Color(204, 0, 0));
        labTunnelAutomatico.setText("***");
        labTunnelAutomatico.setToolTipText("Attivato Tunnel SSH in automatico per database su server TNX");
            ...
            .add(jPanel10Layout.createSequentialGroup()
                ...
                .add(jPanel10Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(jPanel10Layout.createSequentialGroup()
                        .add(jLabel34)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(ssh_hostname, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE))
                    .add(jPanel10Layout.createSequentialGroup()
                        .add(ssh)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(labTunnelAutomatico)
                        .add(0, 60, Short.MAX_VALUE))
                    .add(jPanel10Layout.createSequentialGroup()
                        .add(jLabel35)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(ssh_login, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE))
                    .add(jPanel10Layout.createSequentialGroup()
                        .add(jLabel36)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(ssh_password, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE))
                    .add(jPanel10Layout.createSequentialGroup()
                        .add(jLabel37)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(ssh_porta_locale, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE))
                    .add(jPanel10Layout.createSequentialGroup()
                        .add(jLabel38)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(ssh_porta_remota, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE)))
                .addContainerGap())
        );
            ...
            .add(jPanel8Layout.createSequentialGroup()
                ...
                .add(jPanel8Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel8Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(ssl_truststore, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 95, Short.MAX_VALUE)))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        jPanel5Layout.linkSize(new java.awt.Component[] {cheAvvioDb, texDb, texHost, texId, texPersonalizzazioni}, org.jdesktop.layout.GroupLayout.HORIZONTAL);
        ...
        proxy_auto.setText("Proxy automatico");
        proxy_auto.setToolTipText("Vengono usate le impostazioni di sistema per l'utilizzo del proxy");
        proxy_auto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                proxy_autoActionPerformed(evt);
            }
        });

        jLabel65.setText("Proxy server HTTP");

        proxy_server.setColumns(10);

        proxy_porta.setColumns(5);

        jLabel66.setText("porta");

        jLabel67.setText("Proxy server SOCKS");

        proxy_server_socks.setColumns(10);

        jLabel68.setText("porta");

        proxy_porta_socks.setColumns(5);

        teamviewer.setFont(teamviewer.getFont());
        teamviewer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/it/tnx/invoicex/res/Group-16.png"))); // NOI18N
        teamviewer.setText("Condivisione Desktop");
        teamviewer.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                teamviewerActionPerformed(evt);
            }
        });
                    ...
                    .add(jPanel2Layout.createSequentialGroup()
                        .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                            .add(jPanel2Layout.createSequentialGroup()
                                .add(jLabel67)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(proxy_server_socks, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jLabel68)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(proxy_porta_socks, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                            .add(jPanel2Layout.createSequentialGroup()
                                .add(proxy_auto)
                                .add(18, 18, 18)
                                .add(jLabel65)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(proxy_server, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jLabel66)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(proxy_porta, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .add(teamviewer)))
                .addContainerGap())
        );
        ...
        jLabel25.setToolTipText("Se 'da Ordine' e 'da Preventivo' vengono lasciate vuote verrà usato lo stato originale del documento");

        da_ordine.setToolTipText("Se 'da Ordine' e 'da Preventivo' vengono lasciate vuote verrà usato lo stato originale del documento");
        ...
        testo_timbro_firma.setLineWrap(true);
        ...
        jLabel64.setText("Stringa su conversione da Preventivo");
        jLabel64.setToolTipText("Se 'da Ordine' e 'da Preventivo' vengono lasciate vuote verrà usato lo stato originale del documento");

        da_preventivo.setToolTipText("Se 'da Ordine' e 'da Preventivo' vengono lasciate vuote verrà usato lo stato originale del documento");
        da_preventivo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                da_preventivoActionPerformed(evt);
            }
        });

        jPanel16.setLayout(new java.awt.BorderLayout());

        texNoteStandard.setLineWrap(true);
        texNoteStandard.setRows(3);
        jScrollPane4.setViewportView(texNoteStandard);

        jPanel16.add(jScrollPane4, java.awt.BorderLayout.CENTER);

        jTabbedPane4.addTab("Fattura Vendita", jPanel16);

        jPanel17.setLayout(new java.awt.BorderLayout());

        texNoteStandardDdt.setColumns(20);
        texNoteStandardDdt.setLineWrap(true);
        texNoteStandardDdt.setRows(3);
        jScrollPane11.setViewportView(texNoteStandardDdt);

        jPanel17.add(jScrollPane11, java.awt.BorderLayout.CENTER);

        jTabbedPane4.addTab("DDT Vendita", jPanel17);

        jPanel18.setLayout(new java.awt.BorderLayout());

        texNoteStandardOrdi.setColumns(20);
        texNoteStandardOrdi.setLineWrap(true);
        texNoteStandardOrdi.setRows(5);
        jScrollPane12.setViewportView(texNoteStandardOrdi);

        jPanel18.add(jScrollPane12, java.awt.BorderLayout.CENTER);

        jTabbedPane4.addTab("Ordine Vendita", jPanel18);

        jPanel22.setLayout(new java.awt.BorderLayout());

        texNoteStandardPrev.setColumns(20);
        texNoteStandardPrev.setLineWrap(true);
        texNoteStandardPrev.setRows(5);
        jScrollPane17.setViewportView(texNoteStandardPrev);

        jPanel22.add(jScrollPane17, java.awt.BorderLayout.CENTER);

        jTabbedPane4.addTab("Preventivo Vendita", jPanel22);

        jPanel30.setLayout(new java.awt.BorderLayout());

        texNoteStandardFattAcquisto.setColumns(20);
        texNoteStandardFattAcquisto.setLineWrap(true);
        texNoteStandardFattAcquisto.setRows(5);
        jScrollPane22.setViewportView(texNoteStandardFattAcquisto);

        jPanel30.add(jScrollPane22, java.awt.BorderLayout.CENTER);

        jTabbedPane4.addTab("Fattura Acquisto", jPanel30);

        jPanel31.setLayout(new java.awt.BorderLayout());

        texNoteStandardDdtAcquisto.setColumns(20);
        texNoteStandardDdtAcquisto.setLineWrap(true);
        texNoteStandardDdtAcquisto.setRows(5);
        jScrollPane23.setViewportView(texNoteStandardDdtAcquisto);

        jPanel31.add(jScrollPane23, java.awt.BorderLayout.CENTER);

        jTabbedPane4.addTab("DDT Acquisto", jPanel31);

        jPanel32.setLayout(new java.awt.BorderLayout());

        texNoteStandardOrdiAcquisto.setColumns(20);
        texNoteStandardOrdiAcquisto.setLineWrap(true);
        texNoteStandardOrdiAcquisto.setRows(5);
        jScrollPane24.setViewportView(texNoteStandardOrdiAcquisto);

        jPanel32.add(jScrollPane24, java.awt.BorderLayout.CENTER);

        jTabbedPane4.addTab("Ordine Acquisto", jPanel32);

        jPanel33.setLayout(new java.awt.BorderLayout());

        texNoteStandardPrevAcquisto.setColumns(20);
        texNoteStandardPrevAcquisto.setLineWrap(true);
        texNoteStandardPrevAcquisto.setRows(5);
        jScrollPane25.setViewportView(texNoteStandardPrevAcquisto);

        jPanel33.add(jScrollPane25, java.awt.BorderLayout.CENTER);

        jTabbedPane4.addTab("Preventivo Acquisto", jPanel33);

        jTabbedPane5.addTab("Note da inserire in automatico sui nuovi documenti", jTabbedPane4);

        jPanel20.setLayout(new java.awt.BorderLayout());

        texCondVenditaFatt.setColumns(20);
        texCondVenditaFatt.setLineWrap(true);
        texCondVenditaFatt.setRows(3);
        jScrollPane13.setViewportView(texCondVenditaFatt);

        jPanel20.add(jScrollPane13, java.awt.BorderLayout.CENTER);

        jTabbedPane6.addTab("Fattura", jPanel20);

        jPanel23.setLayout(new java.awt.BorderLayout());

        texCondVenditaDdt.setColumns(20);
        texCondVenditaDdt.setLineWrap(true);
        texCondVenditaDdt.setRows(5);
        jScrollPane14.setViewportView(texCondVenditaDdt);

        jPanel23.add(jScrollPane14, java.awt.BorderLayout.CENTER);

        jTabbedPane6.addTab("DDT", jPanel23);

        jPanel24.setLayout(new java.awt.BorderLayout());

        texCondVenditaOrdi.setColumns(20);
        texCondVenditaOrdi.setLineWrap(true);
        texCondVenditaOrdi.setRows(5);
        jScrollPane15.setViewportView(texCondVenditaOrdi);

        jPanel24.add(jScrollPane15, java.awt.BorderLayout.CENTER);

        jTabbedPane6.addTab("Ordine", jPanel24);

        jPanel25.setLayout(new java.awt.BorderLayout());

        texCondVenditaPrev.setColumns(20);
        texCondVenditaPrev.setLineWrap(true);
        texCondVenditaPrev.setRows(5);
        jScrollPane16.setViewportView(texCondVenditaPrev);

        jPanel25.add(jScrollPane16, java.awt.BorderLayout.CENTER);

        jTabbedPane6.addTab("Preventivo", jPanel25);

        jTabbedPane5.addTab("Condizioni di vendita", jTabbedPane6);

        jPanel26.setLayout(new java.awt.BorderLayout());

        texCondAcquistoFatt.setColumns(20);
        texCondAcquistoFatt.setLineWrap(true);
        texCondAcquistoFatt.setRows(5);
        jScrollPane18.setViewportView(texCondAcquistoFatt);

        jPanel26.add(jScrollPane18, java.awt.BorderLayout.CENTER);

        jTabbedPane7.addTab("Fattura", jPanel26);

        jPanel27.setLayout(new java.awt.BorderLayout());

        texCondAcquistoDdt.setColumns(20);
        texCondAcquistoDdt.setLineWrap(true);
        texCondAcquistoDdt.setRows(5);
        jScrollPane19.setViewportView(texCondAcquistoDdt);

        jPanel27.add(jScrollPane19, java.awt.BorderLayout.CENTER);

        jTabbedPane7.addTab("DDT", jPanel27);

        jPanel28.setLayout(new java.awt.BorderLayout());

        texCondAcquistoOrdi.setColumns(20);
        texCondAcquistoOrdi.setLineWrap(true);
        texCondAcquistoOrdi.setRows(5);
        jScrollPane20.setViewportView(texCondAcquistoOrdi);

        jPanel28.add(jScrollPane20, java.awt.BorderLayout.CENTER);

        jTabbedPane7.addTab("Ordine", jPanel28);

        jPanel29.setLayout(new java.awt.BorderLayout());

        texCondAcquistoPrev.setColumns(20);
        texCondAcquistoPrev.setLineWrap(true);
        texCondAcquistoPrev.setRows(5);
        jScrollPane21.setViewportView(texCondAcquistoPrev);

        jPanel29.add(jScrollPane21, java.awt.BorderLayout.CENTER);

        jTabbedPane7.addTab("Preventivo", jPanel29);

        jTabbedPane5.addTab("Condizioni di acquisto", jTabbedPane7);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .add(jPanel3Layout.createSequentialGroup()
                ...
                .add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel3Layout.createSequentialGroup()
                        .add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jSeparator4, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 556, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(jPanel3Layout.createSequentialGroup()
                                .add(jLabel24)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(da_ddt, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 331, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                            .add(jPanel3Layout.createSequentialGroup()
                                .add(jLabel25)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(da_ordine, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 331, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                            .add(jPanel3Layout.createSequentialGroup()
                                .add(jLabel56)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                            ...
                            .add(jPanel3Layout.createSequentialGroup()
                                .add(jLabel64)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(da_preventivo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 331, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                        .add(0, 0, Short.MAX_VALUE))
                    .add(jPanel3Layout.createSequentialGroup()
                        .add(jLabel17)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
        ...
        jPanel3Layout.linkSize(new java.awt.Component[] {aperturaLabel1, aperturaLabel2, aperturaLabel3, jLabel13, jLabel24, jLabel25, jLabel64}, org.jdesktop.layout.GroupLayout.HORIZONTAL);
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .add(jPanel3Layout.createSequentialGroup()
                ...
                .add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jLabel64)
                    .add(da_preventivo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jLabel13)
                    .add(aperturaFile, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        ...
        jTabbedPane1.addTab("Altro", jScrollPane1);
        ...
        jLabel1.setText("Le percentuali minimo e massimo sono relative allo sconto 1 di testata della fattura.");
        ...
        jLabel31.setToolTipText("Imposta a quale data generare le provvigioni per l'agente (per le nuove provvigioni)");
        ...
        chePercMedia.setText("Calcola la provvigione media fra uno scaglione e l'altro");
        chePercMedia.setToolTipText("Se selezionato calcola la provvigione media fra uno scaglione ed un altro altrimenti imposta la provvigione come inserita in tabella");

        jLabel70.setText("Base su cui calcolare la provvigione");
        jLabel70.setToolTipText("Il cambio dell'impostazione vale per le provvigioni generate da adesso in poi, quelle già generate non vengono ricalcolate");

        provvigioni_tipo_calcolo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Totale imponibile - spese di trasporto - spese di incasso", "Totale imponibile", "Totale iva compresa" }));
        provvigioni_tipo_calcolo.setToolTipText("Il cambio dell'impostazione vale per le provvigioni generate da adesso in poi, quelle già generate non vengono ricalcolate");
        provvigioni_tipo_calcolo.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                provvigioni_tipo_calcoloFocusLost(evt);
            }
        });
            ...
            .add(jPanel9Layout.createSequentialGroup()
                ...
                .add(jPanel9Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                    ...
                    .add(jPanel9Layout.createSequentialGroup()
                        .add(jLabel70)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(provvigioni_tipo_calcolo, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(jSeparator3))
        ...
        texEmiCadFilePre.setColumns(40);
                ...
                .add(panEmiCadLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(panEmiCadLayout.createSequentialGroup()
                        ...
                        .add(panEmiCadLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            ...
                            .add(texEmiCadFilePre))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(panEmiCadLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            .add(butEmiCadFilePost, 0, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .add(butEmiCadFilePre, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .add(jPanel12Layout.createSequentialGroup()
                ...
                .add(jPanel12Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jScrollPane9, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 557, Short.MAX_VALUE)
                    .add(jScrollPane8, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 557, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, jScrollPane7, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 557, Short.MAX_VALUE)
                    .add(jLabel40)
                    .add(jLabel41)
                    .add(jLabel42))
                .addContainerGap())
        ...
        jPanel13Layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel13Layout.createSequentialGroup()
                ...
                .add(jPanel13Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, jScrollPane6, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 557, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, jScrollPane5, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 557, Short.MAX_VALUE)
        ...
        jPanel15.setMaximumSize(new java.awt.Dimension(99, 135));
        jPanel15.setMinimumSize(new java.awt.Dimension(99, 135));
        jPanel15.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel19.setOpaque(false);
        jPanel19.setPreferredSize(new java.awt.Dimension(99, 135));
        ...
        jPanel15.add(jPanel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
        ...
        estraiAccontiFatseq.setText("Includi incassi (campo ACCONTI)");
        estraiAccontiFatseq.setHorizontalTextPosition(javax.swing.SwingConstants.LEFT);

        jLabel72.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel72.setText("Campo esigibilità differita iva");

        texEsigDiffReadytec.setColumns(2);

        styledLabel1.setText("<html><b>0</b> = Immediata<br><b>1</b> = Differita<br><b>2</b> = Differita DL. 185/08<br><b>3</b> = Immediata per note credito/debito</html>");
        styledLabel1.setLineWrap(true);
            ...
            .add(jPanel14Layout.createSequentialGroup()
                ...
                .add(jPanel14Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel14Layout.createSequentialGroup()
                        .add(jLabel72)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(texEsigDiffReadytec, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(styledLabel1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                .add(97, 97, 97))
        );
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/it/tnx/invoicex/res/Checkmark-16.png"))); // NOI18N
        ...
        getContentPane().add(jPanel21, java.awt.BorderLayout.SOUTH);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //controllo eventuali impostazione per conversione allegati non corrette
        for (int i = 0; i < jTabbedPane1.getTabCount(); i++) {
            if (jTabbedPane1.getComponentAt(i) != null && jTabbedPane1.getComponentAt(i).getClass().getName().equals("invoicexplugininvoicex.allegati.JPanelImpostazioniAllegati")) {
                Object tabAllegati = jTabbedPane1.getComponentAt(i);
                System.out.println("tabAllegati = " + tabAllegati);
                try {
                    Boolean ret = (Boolean) tabAllegati.getClass().getMethod("checkImpostazioni").invoke(tabAllegati);
                    if (!ret) {
        ...
        try {
            main.fileIni.setValue("proxy", "auto", proxy_auto.isSelected());
            main.fileIni.setValue("proxy", "server", proxy_server.getText());
            main.fileIni.setValue("proxy", "porta", proxy_porta.getText());
            main.fileIni.setValue("proxy", "server_socks", proxy_server_socks.getText());
            main.fileIni.setValue("proxy", "porta_socks", proxy_porta_socks.getText());
...
//            main.iniPercorsoLogoStampePdf = tnxFileLogo1.getText();
            ...
            if (!vaisudb) {
                try {
                    if (Db.conn != null && !Db.conn.isClosed()) {
                        id = cu.i(dbu.getObject(Db.getConn(), "select id from dati_azienda"));
                        ...
                        sql += " ,label_fornitore = " + Db.pc(this.texLabelFornitore.getText(), "VARCHAR");
                        ...
                        sql += " ,label_fornitore_eng = " + Db.pc(this.texLabelFornitoreEng.getText(), "VARCHAR");
...
//                        sql += " ,targa = " + Db.pc(this.texTarga.getText(), "VARCHAR");
                        ...
                        sql += " , provvigioni_tipo_calcolo = " + Db.pc(provvigioni_tipo_calcolo.getSelectedIndex(), Types.INTEGER);
                        ...
                        try {
                            ...
                            sql += " ,export_fatture_estrai_acconti = " + Db.pc(estraiAccontiFatseq.isSelected() ? "S" : "", Types.VARCHAR);
                            sql += " ,export_fatture_esig_diff_iva = " + Db.pc(texEsigDiffReadytec.getText(), Types.VARCHAR);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
            ...
            if (Db.conn != null && !Db.conn.isClosed()) {
                ...
                try {
                    DbUtils.tryExecQuery(Db.getConn(true), "update dati_azienda set codiceIvaSpese = " + Db.pcs(this.texIvaSpese.getText()) + " where id = " + id);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                ...
                try {
                    DbUtils.tryExecQuery(Db.getConn(true), "update dati_azienda set codiceIvaDefault = " + Db.pcs(this.texIvaDefault.getText()) + " where id = " + id);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                ...
                try {
                    DbUtils.tryExecQuery(Db.getConn(true), "update dati_azienda set codiceIvaBollo = " + Db.pcs(this.texIvaBollo.getText()) + " where id = " + id);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
            ...
            main.fileIni.setValue("pref", "noteStandardDdt", texNoteStandardDdt.getText());
            main.fileIni.setValue("pref", "noteStandardOrdi", texNoteStandardOrdi.getText());
            main.fileIni.setValue("pref", "noteStandardPrev", texNoteStandardPrev.getText());
            main.fileIni.setValue("pref", "noteStandardFattAcquisto", texNoteStandardFattAcquisto.getText());
            main.fileIni.setValue("pref", "noteStandardDdtAcquisto", texNoteStandardDdtAcquisto.getText());
            main.fileIni.setValue("pref", "noteStandardOrdiAcquisto", texNoteStandardOrdiAcquisto.getText());
            main.fileIni.setValue("pref", "noteStandardPrevAcquisto", texNoteStandardPrevAcquisto.getText());

            /* CONDIZIONI DI ACQUISTO E VENDITA */
            main.fileIni.setValue("pref", "condizioniVenditaFattura", texCondVenditaFatt.getText());
            main.fileIni.setValue("pref", "condizioniVenditaDdt", texCondVenditaDdt.getText());
            main.fileIni.setValue("pref", "condizioniVenditaOrdine", texCondVenditaOrdi.getText());
            main.fileIni.setValue("pref", "condizioniVenditaPreventivo", texCondVenditaPrev.getText());
            main.fileIni.setValue("pref", "condizioniAcquistoFattura", texCondAcquistoFatt.getText());
            main.fileIni.setValue("pref", "condizioniAcquistoDdt", texCondAcquistoDdt.getText());
            main.fileIni.setValue("pref", "condizioniAcquistoOrdine", texCondAcquistoOrdi.getText());
            main.fileIni.setValue("pref", "condizioniAcquistoPreventivo", texCondAcquistoPrev.getText());
            ...
            main.fileIni.setValue("altro", "da_preventivo", da_preventivo.getText());
            ...
            main.fileIni.setValue("pref", "colli_automatici", String.valueOf(comColliAutomatici.getSelectedIndex()));
            main.fileIni.setValue("pref", "numerazione_righe", cu.s(comNumerazioneRighe.getSelectedItem()));
...
//                preferences.putBoolean("stampaCellulare", this.cheStampaCellulare.isSelected());
                ...
                main.fileIni.setValue("pref", "stampaFax", this.cheStampaFax.isSelected());
...
//                preferences.putBoolean("azioniPericolose", cheAzioniPericolose.isSelected());
                ...
                main.fileIni.setValue("pref", "provvigioniPercMedia", chePercMedia.isSelected());
...
//                main.fileIni.setValue("pref", "nascondiDonazione", cheNascondiDonazione.isSelected());
                ...
                main.fileIni.setValue("pref", "filtraCliFor", cheFiltraCliFor.isSelected());
                ...
                if (Db.conn != null && !Db.conn.isClosed()) {
                    try {
                        DbUtils.tryExecQuery(Db.getConn(true), "update dati_azienda set gestione_utenti = " + (cheAttivaUtenti.isSelected() ? "1" : "0") + " where id = " + id);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
...
//                preferences.sync();
    ...
    private void aperturaImpostaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aperturaImpostaActionPerformed
        ...
        if (os.startsWith("windows")) {
            ...
            //gvfs-open TODO
            aperturaText1.setText("gvfs-open {file}");
            aperturaText2.setText("gvfs-open {file}");
            aperturaText3.setText("gvfs-open {file}");
        }
...
//            File ftest = fileChoose.getSelectedFile();
            ...
            try {
                if (!main.getPersonalContain("nochecksize")) {
...
//                pack();
    ...
    private void cheStampaDestDiversaSottoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cheStampaDestDiversaSottoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cheStampaDestDiversaSottoActionPerformed

    private void cheStampaPivaSottoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cheStampaPivaSottoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cheStampaPivaSottoActionPerformed

    private void ssh_passwordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ssh_passwordActionPerformed
//        SwingUtils.showErrorMessage(main.getPadreFrame(), ssh_password.getText());
    }//GEN-LAST:event_ssh_passwordActionPerformed

    private void proxy_autoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_proxy_autoActionPerformed
        controllaProxy();
    }//GEN-LAST:event_proxy_autoActionPerformed

    private void da_preventivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_da_preventivoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_da_preventivoActionPerformed

    private void provvigioni_tipo_calcoloFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_provvigioni_tipo_calcoloFocusLost

    }//GEN-LAST:event_provvigioni_tipo_calcoloFocusLost

    private void nomifilepdfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nomifilepdfActionPerformed
        JDialogNomiFilePdf nomipdf = new JDialogNomiFilePdf(main.getPadreFrame(), true);
        nomipdf.setLocationRelativeTo(null);
        nomipdf.setVisible(true);
    }//GEN-LAST:event_nomifilepdfActionPerformed

    private void teamviewerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_teamviewerActionPerformed
        InvoicexUtil.lanciaTeamViewer();
    }//GEN-LAST:event_teamviewerActionPerformed

    private void comIvaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comIvaActionPerformed
        JDialogListaIva dia = new JDialogListaIva(this, true, texIvaDefault, null, null);
        Point p = texIvaDefault.getLocationOnScreen();
        p.translate(0, texIvaDefault.getHeight());
        dia.setLocation(p);
        dia.setSize(400, 300);
        dia.setVisible(true);
    }//GEN-LAST:event_comIvaActionPerformed

    private void comIva1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comIva1ActionPerformed
        JDialogListaIva dia = new JDialogListaIva(this, true, texIvaSpese, null, null);
        Point p = texIvaSpese.getLocationOnScreen();
        p.translate(0, texIvaSpese.getHeight());
        dia.setLocation(p);
        dia.setSize(400, 300);
        dia.setVisible(true);
    }//GEN-LAST:event_comIva1ActionPerformed

    private void comIva2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comIva2ActionPerformed
        JDialogListaIva dia = new JDialogListaIva(this, true, texIvaBollo, null, null);
        Point p = texIvaBollo.getLocationOnScreen();
        p.translate(0, texIvaBollo.getHeight());
        dia.setLocation(p);
        dia.setSize(400, 300);
        dia.setVisible(true);
    }//GEN-LAST:event_comIva2ActionPerformed
    ...
    private javax.swing.JCheckBox cheFiltraCliFor;
    ...
    private javax.swing.JCheckBox chePercMedia;
    ...
    private javax.swing.JCheckBox cheStampaFax;
    ...
    private javax.swing.JComboBox comColliAutomatici;
    ...
    private javax.swing.JButton comIva1;
    private javax.swing.JButton comIva2;
    private javax.swing.JComboBox comListinoBase;
    private javax.swing.JComboBox comLook;
    private javax.swing.JComboBox comNumerazioneRighe;
    ...
    private javax.swing.JTextField da_preventivo;
    private javax.swing.JRadioButton data_fattura;
    private javax.swing.JRadioButton data_scadenza;
    private javax.swing.JCheckBox estraiAccontiFatseq;
    ...
    private javax.swing.JLabel labTunnelAutomatico;
    ...
    private javax.swing.JButton nomifilepdf;
    ...
    private javax.swing.JComboBox provvigioni_tipo_calcolo;
    private javax.swing.JCheckBox proxy_auto;
    private javax.swing.JTextField proxy_porta;
    private javax.swing.JTextField proxy_porta_socks;
    private javax.swing.JTextField proxy_server;
    private javax.swing.JTextField proxy_server_socks;
    ...
    public javax.swing.JScrollPane scrollAzienda;
    ...
    private javax.swing.JButton teamviewer;
    private javax.swing.JTextArea testo_timbro_firma;
    private javax.swing.JTextField texCodIvaReadytec;
    private javax.swing.JTextArea texCondAcquistoDdt;
    private javax.swing.JTextArea texCondAcquistoFatt;
    private javax.swing.JTextArea texCondAcquistoOrdi;
    private javax.swing.JTextArea texCondAcquistoPrev;
    private javax.swing.JTextArea texCondVenditaDdt;
    private javax.swing.JTextArea texCondVenditaFatt;
    private javax.swing.JTextArea texCondVenditaOrdi;
    private javax.swing.JTextArea texCondVenditaPrev;
    ...
    private javax.swing.JTextField texEsigDiffReadytec;
    ...
    private javax.swing.JTextField texIvaBollo;
    ...
    private javax.swing.JTextField texLabelFornitore;
    private javax.swing.JTextField texLabelFornitoreEng;
    ...
    private javax.swing.JTextArea texNoteStandardDdt;
    private javax.swing.JTextArea texNoteStandardDdtAcquisto;
    private javax.swing.JTextArea texNoteStandardFattAcquisto;
    private javax.swing.JTextArea texNoteStandardOrdi;
    private javax.swing.JTextArea texNoteStandardOrdiAcquisto;
    private javax.swing.JTextArea texNoteStandardPrev;
    private javax.swing.JTextArea texNoteStandardPrevAcquisto;
            ...
            SwingWorker work = new SwingWorker() {
                public Object construct() {
                    ...
                    try {
                        ...
                        reports.JRDSOrdine jrInvoice = new reports.JRDSOrdine(Db.getConn(true), dbSerie, dbNumero, dbAnno, booleanPerEmail, false, id, freport);
...
//            prnDdt_tnx temp = new prnDdt_tnx(dbSerie, dbNumero, dbAnno);
    ...
    static public void caricaLogo(String file, JLabel label, String campo) {
        try {
            caricaLogo(file, label, campo, "dati_azienda", "");
        } catch (Exception e) {
    ...
    static public void caricaLogo(String file, JLabel label, String campo, String tabella, String where) {
        try {
            BufferedImage i0 = null;
            if (file == null) {
                try {
                    i0 = ImageIO.read(InvoicexUtil.caricaLogoDaDb(Db.getConn(true), campo, tabella, where));
    ...
    static private void setlabelicon(final JLabel label, final ImageIcon img) {
    ...
    private void controllaProxy() {
        if (proxy_auto.isSelected()) {
            proxy_server.setEnabled(false);
            proxy_porta.setEnabled(false);
            proxy_server_socks.setEnabled(false);
            proxy_porta_socks.setEnabled(false);

            try {
                java.util.List<Proxy> proxys = ProxySelector.getDefault().select(new URI("socket://www.invoicex.it"));
                ...
                if (proxyaddr != null) {
                    proxy_server_socks.setText(proxyaddr.getHostName());
                    proxy_porta_socks.setText(cu.s(proxyaddr.getPort()));
                } else {
                    proxy_server_socks.setText("");
                    proxy_porta_socks.setText("");
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
            try {
                java.util.List<Proxy> proxys = ProxySelector.getDefault().select(new URI("http://www.invoicex.it"));
                System.out.println("HttpUtils getHttpClient proxys http = " + proxys);
                InetSocketAddress proxyaddr = (InetSocketAddress) proxys.get(0).address();
                if (proxyaddr != null) {
                    proxy_server.setText(proxyaddr.getHostName());
                    proxy_porta.setText(cu.s(proxyaddr.getPort()));
                } else {
                    proxy_server.setText("");
                    proxy_porta.setText("");
                }
            } catch (Exception e) {
                e.printStackTrace();
            ...
            proxy_server.setEnabled(true);
            proxy_porta.setEnabled(true);
            proxy_server_socks.setEnabled(true);
            proxy_porta_socks.setEnabled(true);

            proxy_server.setText(main.fileIni.getValue("proxy", "server", ""));
            proxy_porta.setText(main.fileIni.getValue("proxy", "porta", ""));
            proxy_server_socks.setText(main.fileIni.getValue("proxy", "server_socks", ""));
            proxy_porta_socks.setText(main.fileIni.getValue("proxy", "porta_socks", ""));
        }
    }
}
