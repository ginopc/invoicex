...
public class JDialogAccesso extends JDialog {
    ...
    public JDialogAccesso(Frame parent, boolean modal, int tentativi, String user) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setToolTipText("Se è la prima volta che hai attivato la gestione utenti, Utente e Password sono admin/admin");
    ...
    public javax.swing.JTextField texUsername;
