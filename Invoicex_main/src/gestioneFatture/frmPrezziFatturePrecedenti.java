...
public class frmPrezziFatturePrecedenti
    ...
    public frmPrezziFatturePrecedenti(int codiceCliente, String codiceArticolo, String tipo) {
        initComponents();        
        String sql = "select " + (Db.isTipoDocAcquisto(tipo) ? "t.fornitore" : "t.cliente") + ", t.data, r.codice_articolo, r.descrizione, r.um, r.quantita, r.prezzo,"
                + " r.sconto1, r.sconto2 "
                + getFrom(tipo)
                + " where " + (Db.isTipoDocAcquisto(tipo) ? "t.fornitore" : "t.cliente") + " = " + codiceCliente;
   ...
   */
    ...
    private String getFrom(String tipo) {
        ...
        } else if (tipo.equals(Db.TIPO_DOCUMENTO_DDT_ACQUISTO)) {
