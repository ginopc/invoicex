...
//            //datatable.setCellpadding(1);
            ...
            while (continua == true) {
                ...
                if (Db.nz(resu.getString("t.opzione_riba_dest_diversa"), "N").equalsIgnoreCase("S")) {

                    //allora stampo la dest diversa
                    c = new Cell(new Phrase(Db.nz(resu.getString("t.dest_ragione_sociale"), ""), new Font(Font.HELVETICA, 8, Font.NORMAL)));
                    c.add(new Phrase(" (cod. " + resu.getString("clie_forn_codice") + ")", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                    c.add(new Phrase("\n" + resu.getString("t.dest_indirizzo"), new Font(Font.HELVETICA, 8, Font.NORMAL)));
                    c.add(new Phrase("\n" + resu.getString("t.dest_cap") + " " + resu.getString("t.dest_localita") + "(" + resu.getString("t.dest_provincia") + ")", new Font(Font.HELVETICA, 8, Font.NORMAL)));
                } else {
                ...
                c.add(new Phrase("\nBanca (ABI " + Db.nz(resu.getString("t_banca_abi"), "") + ") " + Db.nz(resu.getString("banche_abi_nome"), ""), new Font(Font.HELVETICA, 8, Font.NORMAL)));
                c.add(new Phrase("\nAgenzia (CAB " + Db.nz(resu.getString("t_banca_cab"), "") + ") " + Db.nz(resu.getString("comuni_comune"), "") + " indirizzo " + Db.nz(resu.getString("banche_cab_indirizzo"), ""), new Font(Font.HELVETICA, 8, Font.NORMAL)));
                set2(c);
                datatable.addCell(c);
                c = new Cell();
                ...
                while (continua1 == true) {
                    ...
                    if (c.getElements().hasNext() == true) {
                        c.add(new Phrase("\n\nFattura " + Db.nz(resu.getString("t.serie"), "") + Db.nz(resu.getString("t.numero"), "") + " del " + Db.formatData(resu.getString("t.data")), new Font(Font.HELVETICA, 7, Font.NORMAL)));
                    } else {
                        c.add(new Phrase("Fattura " + Db.nz(resu.getString("t.serie"), "") + Db.nz(resu.getString("t.numero"), "") + " del " + Db.formatData(resu.getString("t.data")), new Font(Font.HELVETICA, 7, Font.NORMAL)));
                    }

                    double dapagare = resu.getDouble("t.totale");
                    if (CastUtils.toDouble0(resu.getDouble("t.totale_da_pagare")) != 0) {
                        dapagare = resu.getDouble("t.totale_da_pagare");
                    }
                    ...
                    while (continua2 == true) {
                        ...
                        oldCliente = resu.getString("clie_forn_codice");
                        oldFattura = resu.getString("t.serie") + resu.getString("t.numero");
                        ...
                        if (resu.next() != true) {
                            ...
                            if (!oldFattura.equals(resu.getString("t.serie") + resu.getString("t.numero"))) {
                                continua2 = false;
                                resu.previous();
                            }
                        }
                    ...
                    if (it.tnx.Util.round(totaleFattura, 2) != it.tnx.Util.round(totaleScadenze, 2)) {
                        documentiAnomali.add(Db.nz(resu.getString("t.numero"), "") + " del " + Db.formatData(resu.getString("t.data")) + " tot. Fattura:" + it.tnx.Util.formatValutaEuro(totaleFattura) + " tot. Scad.:" + it.tnx.Util.formatValutaEuro(totaleScadenze));
                    }
