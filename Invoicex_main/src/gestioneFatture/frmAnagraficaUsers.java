...
public class frmAnagraficaUsers extends javax.swing.JInternalFrame {
    ...
    private void controllaAdmin() {
        System.out.println("texCodi.getText():" + texCodi.getText());
        System.out.println("texUsername.getText():" + texUsername.getText());
        boolean enabled = true;
        if (texUsername.getText().equalsIgnoreCase("admin") && texCodi.getText().equals("1")) {
            enabled = false;
        }
        texUsername.setEnabled(enabled);
        comRoleId.setEnabled(enabled);
        butSave.setEnabled(enabled);
        butDele.setEnabled(enabled);
    }
    ...
    private void initComponents() {
        ...
        texDbPassword.setBackground(new java.awt.Color(255, 153, 51));
        ...
        texCodi.setBackground(new java.awt.Color(255, 51, 51));
        texCodi.setText("id");
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .addContainerGap())
            .add(org.jdesktop.layout.GroupLayout.TRAILING, tabCent)
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(tabCent, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
    ...
    private void butDeleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butDeleActionPerformed
        if (CastUtils.toInteger0(this.texCodi.getText()) == 1 && texUsername.getText().equalsIgnoreCase("admin")) {
            SwingUtils.showInfoMessage(this, "Non puoi eliminare l'utente admin", "Attenzione");
            return;
        } else {
...
//        }
    ...
    private void btnAzzeraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAzzeraActionPerformed
        if (SwingUtils.showYesNoMessage(this, "Azzerando le password il tuo account non avrà più protezione, sicuro di proseguire?", "Azzeramento Password")) {
            String sql = "UPDATE accessi_utenti SET password = " + Db.pc(InvoicexUtil.md5(""), Types.VARCHAR) + " "
                    + " WHERE id = " + Db.pc(this.texCodi.getText(), Types.INTEGER);
            Db.executeSql(sql);
