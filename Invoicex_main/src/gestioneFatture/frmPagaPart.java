...
//        chiave.add("data_scadenza");
        ...
        sql += " and id_doc = " + Db.pc(scadenze.documento_id, Types.INTEGER);
        sql += " order by id";
        ...
        colsWidthPerc.put("Pagata", new Double(3));
        ...
        Map m = null;
        try {
            m = InvoicexUtil.getSerieNumeroAnno(scadenze.documento_tipo, scadenze.documento_id);
        } catch (Exception e) {
            e.printStackTrace();
        }
        
        this.labDocu.setText("Scadenze del documento: " + tipodesc + " " + m.get("serie") + m.get("numero") + " del " + DateUtils.formatDate(scadenze.documento_data));
        //azzero la data su scadenze in modo da fargliela riprendere dal documento
        scadenze.documento_data = null;
        ...
        sql += " where id = " + Db.pc(scadenze.documento_id, Types.INTEGER);
...
//        timTotali.schedule(timRefresh, 5000, 500);
    ...
    private void initComponents() {
        ...
        texId.setBackground(new java.awt.Color(255, 102, 102));
        texId.setColumns(5);
        texId.setText("id");
        ...
        labId.setBackground(new java.awt.Color(255, 102, 102));
        ...
        if (tabParziali.getColumnModel().getColumnCount() > 0) {
        ...
        jLabel2.setText("Pagamenti effettuati");
        ...
        datiLayout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, datiLayout.createSequentialGroup()
                ...
                .add(datiLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, datiLayout.createSequentialGroup()
                        .add(labId, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 40, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                    ...
                    .add(datiLayout.createSequentialGroup()
                        .add(datiLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            ...
                            .add(jLabel2211, 0, 1, Short.MAX_VALUE)
                            ...
                            .add(org.jdesktop.layout.GroupLayout.LEADING, datiLayout.createSequentialGroup()
                                .add(datiLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                    .add(datiLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                                        ...
                                        .add(texImpo, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            ...
            .add(datiLayout.createSequentialGroup()
                ...
                .add(datiLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(datiLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                        .add(labDocu)
                        .add(texId, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(labId, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 20, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (javax.swing.JOptionPane.showConfirmDialog(this, "Sicuro di rigenerare le scadenze?", "Attenzione", javax.swing.JOptionPane.YES_NO_OPTION) == javax.swing.JOptionPane.YES_OPTION) {
            ...
            try {
                Map m = InvoicexUtil.getSerieNumeroAnno(scadenze.documento_tipo, scadenze.documento_id);
                Storico.scrivi("Genera scadenze", "da frmPagaPart " + scadenze.documento_tipo + " " + m.get("serie") + " " + m.get("numero") + " " + m.get("anno"));
            } catch (Exception e) {
            }
            try {
    ...
    private void butDeleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butDeleActionPerformed
        ...
        if (ret == JOptionPane.YES_OPTION) {
            ...
            InvoicexUtil.aggiornaScadenze(scadenze.documento_tipo, scadenze.documento_id);
            this.griglia.dbRefresh();
        }
    ...
    private void butSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butSaveActionPerformed
        ...
        if (chePagata.isSelected() && getMancante() > 0) {
            if (!SwingUtils.showYesNoMessage(this, "La scadenza e' segnata come Pagata ma risultano da pagare ancora: " + getMancante() + ", confermi ?")) {
                return;
            }
        }
        if (cheNonPagata.isSelected() && getMancante() == 0) {
            if (!SwingUtils.showYesNoMessage(this, "La scadenza e' segnata come NON Pagata ma non risulta gia' pagata" + ", confermi ?")) {
                return;
            }
        }
        if (cheParziale.isSelected() && getMancante() == 0) {
            if (!SwingUtils.showYesNoMessage(this, "La scadenza e' segnata come Pagata Parzialmente ma risulta pagata completamente, confermi ?")) {
                return;
            }
        }
        if (cheParziale.isSelected() && getMancante().doubleValue() == getTotaleScadenza().doubleValue()) {
            if (!SwingUtils.showYesNoMessage(this, "La scadenza e' segnata come Pagata Parzialmente ma risulta da pagare interamente, confermi ?")) {
                return;
            }
        }
    ...
    private void butNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butNewActionPerformed
        ...
        try {
            ...
            sql += " and id_doc = " + Db.pc(this.scadenze.documento_id, Types.INTEGER);
        ...
        this.texDocuId.setText(cu.s(scadenze.documento_id));
        
        texDataScad.requestFocus();
    ...
    private void aggiornaSituazioni() {
        ...
        for (JInternalFrame frame : frames) {
            if (frame instanceof JInternalFrameScadenzario) {
                ((JInternalFrameScadenzario) frame).selezionaSituazione(false);
//            } else if (frame.getContentPane().getComponent(0) instanceof SituazioneClienti) {
