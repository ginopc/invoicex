...
public class JDialogStorico extends javax.swing.JDialog {
    ...
    private void riempiTab(DatiStorico dati) {
        ...
        String inte = "<html>" + (StringUtils.isEmpty(CastUtils.toString(testa.get("serie"))) ? "" : testa.get("serie") + "/") + testa.get("numero") + " del " + DateUtils.formatDate((Date)testa.get("data")) + " anno:" + testa.get("anno") + " tipo_fattura:" + testa.get("tipo_fattura") + " pagamento:" + testa.get("pagamento");
        inte += "<br>";
...
//                    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (SwingUtils.showYesNoMessage(this, "Sicuro di ripristinare questa versione ?\n(La versione sostituita verrà storicizzata)")) {
            InvoicexUtil.storicizza("ripristino id:" + id_doc, tipo_doc, id_doc, false);
