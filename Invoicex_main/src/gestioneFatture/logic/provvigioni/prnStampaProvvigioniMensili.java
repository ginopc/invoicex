...
//            datatable.setDefaultCellBorderColor(new Color(200, 200, 200));
            ...
            while (resu.next()) {
                ...
                set2(c);
                datatable.addCell(c);
                c = new Cell((new Phrase(resu.getString("serie") + resu.getString("numero") + " del " + it.tnx.Util.formatDataItalian(resu.getDate("data")), new Font(Font.HELVETICA, 8, Font.NORMAL))));
                set2(c);
                datatable.addCell(c);
