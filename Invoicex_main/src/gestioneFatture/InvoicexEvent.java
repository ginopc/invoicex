...
public class InvoicexEvent extends EventObject {
    ...
    public static final int TYPE_FRMTESTFATT_ACQUISTO_DOPO_SAVE = 1022;
    ...
    public static final int TYPE_FRMTESTDDT_INIT_INSERIMENTO = 55;
    public static final int TYPE_FRMTESTFATT_INIT_INSERIMENTO = 56;
    public static final int TYPE_FRMTESTFATT_ACQUISTO_INIT_INSERIMENTO = 57;
    public static final int TYPE_FRMTESTORDI_INIT_INSERIMENTO = 58;
    public static final int TYPE_FRMGIACENZE_CONSTR_POST_INIT_COMPS = 59;
    public static final int TYPE_EXPORTAV_FORNITORE_POST_SELECTION = 60;
    public static final int TYPE_FRMCLIE_PRE_DELETE = 61;
    
    public static final int TYPE_FRMELENFATT_ACQUISTO_CONSTR_POST_INIT_COMPS = 62;
    
    public static final int TYPE_FRMELENORDINI_DELETE_PRE = 63;
    
    public static final int TYPE_NUOVI_MOVIMENTI_MAGAZZINO_INS_RIGA_DEP_ARRIVO = 64;
    
    public static final int TYPE_FRMELENDDT_POST_DELETE = 65;
    public static final int TYPE_FRMELENORDI_POST_DELETE = 66;
    
    public static final int TYPE_UPDATE_DISP_DA_GENERA_MOVIMENTI = 67;
    

    //generici
    public static final int TYPE_GENERIC_PreInitComps = 100;
    public static final int TYPE_GENERIC_PostInitComps = 101;
    public static final int TYPE_GENERIC_PostSetupDati = 102;
    public static final int TYPE_GENERIC_ConvDocRiga = 103;
    
    //Allegati
    public static final int TYPE_AllegatiInit = 200;
    public static final int TYPE_AllegatiCarica = 201;
    public static final int TYPE_AllegatiSalva = 202;
    
    //main
    public static final int TYPE_MAIN_controlli = 500;
