...
public class frmListini
    ...
    public frmListini() {
        ...
        this.dati.dbOpen(Db.getConn(), "select * from tipi_listino order by codice", Db.INSTANCE);
        this.dati.dbRefresh();
    ...
    private void butDeleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butDeleActionPerformed
        ...
        if (ret == JOptionPane.YES_OPTION) {
            ...
            Storico.scrivi("elimina listino", texCodice.getText() + " " + texDescrizione.getText());
    ...
    private void butSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butSaveActionPerformed
        ...
        String listinoRicarico = null;
        try {
            listinoRicarico = cu.s(((KeyValuePair)ricarico_listino.getSelectedItem()).key);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void aggiornaPrezziListinoRicarico(String listino, String listinoRicarico, Double perc) {
        ...
        Db.executeSql("DELETE FROM articoli_prezzi WHERE listino = " + dbu.sql(listino));
        ...
        try {
            while (rs.next()) {
                ...
                Db.executeSql("INSERT INTO articoli_prezzi SET articolo = " + dbu.sql(codiceArticolo) + ", listino = " + dbu.sql(listino) + ", prezzo = " + dbu.sql(prezzo));
            }
