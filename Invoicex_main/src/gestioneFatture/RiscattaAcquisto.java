            ...
            Thread tattivazione = new Thread("attivazione") {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        String codice_fiscale = main.attivazione.getDatiAzienda().getCodice_fiscale();
                        String url = main.baseurlserver + "/a.php"
                                + "?o=" + URLEncoder.encode(ordine, "ISO-8859-1")
                                + "&pi=" + URLEncoder.encode(partiva_iva, "ISO-8859-1")
                                + "&cf=" + URLEncoder.encode(codice_fiscale, "ISO-8859-1")
                                + "&v=" + URLEncoder.encode(vl, "ISO-8859-1")
                                + (main.attivazione.getIdRegistrazione() != null ? "&i=" + main.attivazione.getIdRegistrazione() : "")
                                + "&so=" + URLEncoder.encode(System.getProperty("os.name") + ":" + System.getProperty("os.version"), "ISO-8859-1");
                    ...
                    //se trovo form di disattivazione la chiudo
                    ...
                    SwingUtils.inEdt(new Runnable() {
                        public void run() {
                            ...
                            if (main.fileIni.getValueBoolean("plugin_invoicex", "nuova_attivazione", false)) {
...
//            List<Plugin> plugins = service.getPlugins2(false);
    ...
    public static void cambiaIcone(String versione) {
        try {
            main.check_connessione();   //se fallisce esce
        } catch (Exception ex) {
            ex.printStackTrace();
            return;
        }
        ...
        if (!main.fileIni.getValue("varie", "ver_icone", "").equals(estver) || !controllologovertxt) {
            if (PlatformUtils.isWindows()) {
                //cambio exe
                try {
                    String url = main.baseurlserver + "/download/invoicex/Invoicex-" + estver + ".exe";
                    ...
                    //elimino icon cache
                    String filecache = main.getUserHome() + "\\AppData\\Local\\IconCache.db";
                    ...
                    if (os.equals("windows 95")
                        ...
                        filecache = main.getUserHome() + "\\Local Settings\\Application Data\\IconCache.db";
                    }
                ...
                if (!a.exists() || a.renameTo(aold)) {
                    String url = main.baseurlserver + "/download/invoicex/icone/mac/" + estver + ".icns";
                    try {
                ...
                if (!a.exists() || a.renameTo(aold)) {
                    String url = main.baseurlserver + "/download/invoicex/icone/png/" + estver + "/512x512_24.png";
                    try {
                        HttpUtils.saveFile(url, a.getAbsolutePath());
                    } catch (Exception ex) {
                        ex.printStackTrace();
            ...
            if (!a.exists() || a.renameTo(aold)) {
                String url = main.baseurlserver + "/download/invoicex/icone/win/" + estver + ".ico";
                try {
                    HttpUtils.saveFile(url, a.getAbsolutePath());
                } catch (Exception ex) {
                    ex.printStackTrace();
            ...
            try {
                ...
                String url = main.baseurlserver + "/download/invoicex/icone/png/" + estver + "/48x48_8.gif";
                try {
                    HttpUtils.saveFile(url, a.getAbsolutePath());
                } catch (Exception ex) {
                    ex.printStackTrace();
            ...
            try {
                ...
                String url = main.baseurlserver + "/download/invoicex/splashscreen/" + estver + ".png";
                try {
                    HttpUtils.saveFile(url, a.getAbsolutePath());
                } catch (Exception ex) {
                    ex.printStackTrace();
