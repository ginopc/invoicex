...
public class frmNuovRigaDescrizioneMultiRigaNewFrajor
     ...
     */
    public frmNuovRigaDescrizioneMultiRigaNewFrajor(Object from, String dbStato, String dbSerie, int dbNumero, String stato, int dbRiga, int dbAnno, String codiceListino, int codiceCliente, Integer id_riga, Integer id_padre) throws IOException {
        //texRicerca
        initComponents();
...
//                }
    ...
    private void initComponents() {
        ...
        butNew.setIcon(new javax.swing.ImageIcon(getClass().getResource("/it/tnx/invoicex/res/Delete Sign-16.png"))); // NOI18N
...
//        main.events.fireInvoicexEvent(new InvoicexEvent(this, InvoicexEvent.TYPE_FRMNuovRigaDescrizioneMultiRigaNew_INSERIMENTO));
    ...
    class AggiornaResiduaWorker extends SwingWorker {
        ...
        protected Object doInBackground() throws Exception {
            ...
            ArrayList giacenza = main.magazzino.getGiacenza(false, codart, null);
