 ...
 * @author Marco
 */
public class JDialogBugMovDepArrivo extends javax.swing.JDialog {

    /**
     * Creates new form JDialogBugMassimaleRivalsa
     */
    public JDialogBugMovDepArrivo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Controllo bug movimentazione deposito di arrivo da DDT");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        it.tnx.PrintUtilities.printComponent(text);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogBugMovDepArrivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogBugMovDepArrivo dialog = new JDialogBugMovDepArrivo(new javax.swing.JFrame(), true);
