...
public class JDialogExc extends javax.swing.JDialog {
    ...
    public JDialogExc(java.awt.Frame parent, boolean modal, Throwable e) {
        ...
        this.e = e;
        initComponents();
        inviasegnalazione.setVisible(false);
        try {
    ...
    public JDialogExc(java.awt.Frame parent, boolean modal, Throwable e, String msg_sotto) {
        super(parent, modal);
        e.printStackTrace();
        this.e = e;
        this.msg_sotto = msg_sotto;
        initComponents();
        inviasegnalazione.setVisible(false);
        try {
            ((java.awt.Frame)getOwner()).setIconImage(main.getLogoIcon());
    ...
    private void initComponents() {
        ...
        inviasegnalazione = new javax.swing.JButton();
        ...
        labInt.addMouseListener(formListener);
        ...
        if (e != null) {labe.setText(StringUtils.abbreviate(e.getLocalizedMessage(), 100));} else {labe.setText(msg_sotto);};

        inviasegnalazione.setFont(inviasegnalazione.getFont());
        inviasegnalazione.setText("Invia segnalazione errore");
        inviasegnalazione.addActionListener(formListener);
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                        ...
                        .add(inviasegnalazione)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jButton2))
                    .add(labInt, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private class FormListener implements java.awt.event.ActionListener, java.awt.event.MouseListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == inviasegnalazione) {
                JDialogExc.this.inviasegnalazioneActionPerformed(evt);
            }
        ...
        public void mouseClicked(java.awt.event.MouseEvent evt) {
            if (evt.getSource() == labInt) {
                JDialogExc.this.labIntMouseClicked(evt);
            }
        }
    ...
    private void inviasegnalazioneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inviasegnalazioneActionPerformed
        ...
        dispose();
    }//GEN-LAST:event_inviasegnalazioneActionPerformed
    ...
    private void labIntMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labIntMouseClicked
        if (evt.getClickCount() >= 2) {
            inviasegnalazione.setVisible(true);
        }
    }//GEN-LAST:event_labIntMouseClicked
    ...
    public javax.swing.JButton inviasegnalazione;
    ...
    static public void showExc(Frame comp, boolean modal, Exception e, String intestazione) {
        ...
        if (intestazione != null) {
            ...
            de.labInt.setFont(de.labInt.getFont().deriveFont(Font.BOLD, de.labInt.getFont().getSize()+2));
        }
