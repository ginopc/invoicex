...
import static it.tnx.Db2.bytesToHex;
...
public class Util {
    ...
    public static boolean createThumbnail(Image image, String newFileName, int newWidth) {
        ...
        if (is.getWidth(null) > 0) {
            try {
                ...
                ImageIO.write((BufferedImage) is, "jpeg", fos);
                fos.close();
            } catch (Exception err) {
                err.printStackTrace();
                return false;
    ...
    */
    ...
    public static double round_old(double x, int decimals) {  // rounds to the  nearest integer
        //errore 4.10 - 5% sconto
        //test = 4.10d - (4.10d / 100d * 5d); -> 3.8949999999999996 arrotondava a 3.89 invece di 3.90
    ...
    public static double round_old2(double x, int decimals) {  // rounds to the  nearest integer
        int factor = 1;
    ...
    public static double round_old3(double x, int decimals) {  // rounds to the  nearest integer
...
//            PrintStream o = new PrintStream(outputStream, true, "ISO-8859-1");
            ...
            if (tipo == null || !tipo.equalsIgnoreCase("VIEW")) {
                ArrayList<String> campiblob = new ArrayList();
                ...
                while (ancora) {
                    ...
                    while (resu.next()) {
                        ...
                        sb.setLength(0);
                        if (tableName.equalsIgnoreCase("files")) {
                            //se tabella files inserisco un record con il blob vuoto e poi ciclo tot per tot per appendere il blob
                            sb.append("insert into " + tableName + " values (");
                            Integer pk = cu.i(resu.getObject("id"));
...
//                                    }
//                                } else {
//                                    valoreCampo = dbu.sql(resu.getObject(i));
//                                    sb.append("`" + meta.getColumnName(i) + "` = " + valoreCampo);                                    
//                                }
//                                if (i != columns) {
//                                    sb.append(",");
//                                }
...
//                            sb.append(";");                            
                            ...
                            //ciclo i blob
                            for (int i = 0; i < campiblob.size(); i++) {
                                String campo = campiblob.get(i);
                                ...
                                if (is != null) {
                                    ...
                                    while ((read = is.read(buff)) >= 0) {
                                        if (read > 0) {
                                            String parte = bytesToHex(buff, 0, read);
...
//            }
    ...
    public static void main(String[] args) {
        System.out.println(round(511.115, 2));
...
//        System.out.println(round2(test, 2));
//        System.out.println(round3(test, 2));
//        System.out.println("---");
//
//        test = 586.785;
//        System.out.println(round(test, 2));
...
//        System.out.println(round3(test, 2));
        ...
        double test = 0.145;
        System.out.println(test + " " + round(test, 2) + " " + round_old2(test, 2));
        System.out.println("-----------------");
...
//        test = 4.10d - (4.10d / 100d * 5d);
        test = 4.10f * 0.95f;
        System.out.println(test + " " + round(test, 2) + " " + round_old2(test, 2) + " " + FormatUtils.formatEuroItaMax5(test));
        System.out.println("-----------------");

        //34,62*1.04=36.0048
        test = 34.62f * 1.04f;
        System.out.println(test + " " + round(test, 2) + " " + round_old2(test, 2) + " " + round_old3(test, 2) + " " + FormatUtils.formatEuroItaMax5(test));
        System.out.println("-----------------");
        ...
        for (int i = 0; i < 10000; i++) {
            ...
            String val1 = cu.s(nf2.format(round(val, 2)));
            if (!val1.equals(ver2.toPlainString())) {
        ...
        /*
         ...
         val += 0.001d;
         String val1 = cu.s(round(val, 2));
         String val2 = cu.s(round_old2(val, 2));
         if (!val1.equals(val2)) {
         System.out.println("diversi " + val + " vald:" + val + " " + val1 + " " + val2);
         }
         }
        
         double valf = 4.10d;
         for (int i = 0; i < 100; i++) {
         val = valf - (valf / 100d * (double)i);
         String val1 = cu.s(round(val, 2));
         String val2 = cu.s(round_old2(val, 2));
         if (!val1.equals(val2)) {
         System.out.println("diversi " + val + "/" + i + " vald:" + val + " " + val1 + " " + val2);
         }
         }        
         */
    }
