...
public class BalloonTip extends JPanel {
     ...
     * @param attachLocation	location of the balloon's tip within the attached
     * component
     ...
     * @param style	the balloon tip's looks (may not be null)
     * @param positioner	determines the way the balloon tip is positioned (may
     * not be null)
     * @param closeButton	the close button to be used for the balloon tip (may
     * be null)
     */
     ...
     * balloon tip permanently by calling closeBalloon() if false, the button's
     * behaviour is to hide the balloon tip by calling setVisible(false)
     */
     ...
     * balloon tip permanently by calling closeBalloon() if false, the default
     * behaviour is to just hide the balloon tip by calling setVisible(false)
     */
     ...
     * balloon tip have no reason to hide the balloon tip! For example, it makes
     * no sense to show balloon tip if the component it's attached to is
