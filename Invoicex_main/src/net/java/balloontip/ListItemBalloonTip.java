...
public class ListItemBalloonTip extends CustomBalloonTip {
    ...
    public ListItemBalloonTip(JComponent attachedComponent, JComponent component, Rectangle offset, BalloonTipStyle style, Orientation orientation, AttachLocation attachLocation, int horizontalOffset, int verticalOffset, boolean useCloseButton) {
        super(attachedComponent, component, offset, style, orientation, attachLocation, horizontalOffset, verticalOffset, useCloseButton);
    }
